...
/**
 * Делегирует все вызовы к реальному DAO.
 */
class CalendarRepositoryImpl(
    ...
    override suspend fun getCompletedCountBetweenDates(startDate: String, endDate: String): Int =
        withContext(Dispatchers.IO) {
            dao.getCompletedCountBetweenDates(startDate, endDate)
        }

    override suspend fun getTotalTaskOccurrencesBetweenDates(startDate: String, endDate: String): Int =
        withContext(Dispatchers.IO) {
